...
Finalmente, hay que elegir una llave para decodificar el mensaje, esta llave solo debe conocerla el receptor del mensaje. Como ya lo mencionamos, nuestra llave ser\'a una matriz de $2\times 2$. Hay que elegirla invertible, esto es fundamental, como veremos a la hora de decodificar el mensaje. Supongamos que es:
